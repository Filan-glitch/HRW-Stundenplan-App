...
class TimetableWidgetTomorrowService : RemoteViewsService() {
    override fun onGetViewFactory(intent: Intent?): RemoteViewsFactory {
        return TimetableWidgetTomorrowItemFactory(applicationContext, intent!!)
    }

    class TimetableWidgetTomorrowItemFactory(private val context: Context, intent: Intent) : RemoteViewsFactory {
        ...
        override fun onCreate() {
            timetableData = dataProvider.getTomorrowEvents(context).map { it.toString() }
        }
